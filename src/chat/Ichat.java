...
public interface Ichat extends java.rmi.Remote
{
    ...
    public void managerMessage(String senderId, String receiverId, String msgContent, String date) throws java.rmi.RemoteException;
    public ArrayList<Chatter> getHistory(String senderId, String receiverId) throws java.rmi.RemoteException;
